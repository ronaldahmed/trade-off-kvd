...
class SciBertScorer:
    ...
    """ Reformats to SacreRouge output format / differs from sacrerouge.bertscore's bertscore.run (score_multi_all)"""
    def score_all(self, summaries, references_list):
        ...
        # Score the summaries
        precisions, recalls, f1s = self.score(input_candidates,input_references)
